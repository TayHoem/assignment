...
class ClaimControllerTest {
    ...
    private static final String EMPLOYEE_NUMBER = "E001";
    ...
    class CreateClaim {
        ...
        void claimController_createClaim_success() throws Exception {
            // Given
    ...
    class AddItemToClaim {
        ...
        void claimController_addItem_success() throws Exception {
            // Given
