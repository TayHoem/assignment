...
class ApprovalControllerTest {
    ...
    class CreateApproval {
        ...
        void approvalController_createApproval_success() throws Exception {
            // Given
            ...
            given(approvalService.createApproval(eq(EMPLOYEE_ID), eq(CLAIM_ID), any(ApprovalRequestDTO.class))).willReturn(approvalResponse);
